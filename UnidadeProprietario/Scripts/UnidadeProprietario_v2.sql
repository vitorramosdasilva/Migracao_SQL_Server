...
Where (UP.Empresa_unid Between 1 And 1500
	...
	--And Upro.CodPes_unp Is Not Null
	--And c.cod_pes Is Not Null

Order By P.Descricao_psc ,UP.Identificador_unid 


Update P
	Set P.CodPes_unp = Upro.CodPes_unp
From #Tb_Pessoas P
Inner Join [dbo].[UnidadeProprietario] Upro
On   P.Empresa_unp = Upro.Empresa_unp
And P.[Prod_unp] = Upro.[Prod_unp]
And P.NumPer_unp = Upro.[NumPer_unp]
Where p.CodPes_unp Is Null

Update P
	Set P.CodPes_unp = Udep.CodPes_und
From #Tb_Pessoas P
Inner Join [dbo].[UnidadeDepositario] Udep
On   P.Empresa_unp = Udep.Empresa_und
And P.[Prod_unp] = Udep.Prod_und
And P.NumPer_unp = Udep.[NumPer_und]
Where p.CodPes_unp Is Null

Update P
	Set P.CodPes_unp = UproH.CodPes_unph
From #Tb_Pessoas P
Inner Join [dbo].UnidadeProprietarioHist UproH
On   P.Empresa_unp = UproH.Empresa_unph
And P.[Prod_unp] = UproH.[Prod_unph]
And P.NumPer_unp = UproH.[NumPer_unph]
Where p.CodPes_unp Is Null
...
Where (UP.Empresa_unid Between 1 And 1500)	
	...
	Not Exists (Select 1 
					...
					Where Cpp.Empresa_unp = UP.Empresa_unp 
					And Cpp.Prod_unp = UP.Prod_unp 
					And Cpp.NumPer_unp = UP.NumPer_unp
					And Cpp.CodPes_unp = Up.CodPes_unp							
				)
...
-- Teste --
--select * From #Tb_Sem_Pessoas p
--Where p.codpes_unp is Not null
